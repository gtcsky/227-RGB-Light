 ...
 ** \retval Ok or Error
 *****************************************************************************/
en_result_t Pca_CmpDataSet(en_pca_module_t enModule, uint8_t initData,uint8_t cmpData)
{
    en_result_t enResult = Error;
    ...
    {
        case Module0:
            M0P_PCA->CCAP0L_f.CCAP0 = initData;
            M0P_PCA->CCAP0H_f.CCAP0 = cmpData;
            enResult = Ok;
            break;             
        case Module1:          
            M0P_PCA->CCAP1L_f.CCAP1 = initData;
            M0P_PCA->CCAP1H_f.CCAP1 = cmpData;
            enResult = Ok;
            break;             
        case Module2:
            M0P_PCA->CCAP2L_f.CCAP2 = initData;
            M0P_PCA->CCAP2H_f.CCAP2 = cmpData;
            enResult = Ok;
            break;             
        case Module3:          
            M0P_PCA->CCAP3L_f.CCAP3 = initData;
            M0P_PCA->CCAP3H_f.CCAP3 = cmpData;
            enResult = Ok;
            break;             
        case Module4:          
            M0P_PCA->CCAP4L_f.CCAP4 = initData;
            M0P_PCA->CCAP4H_f.CCAP4 = cmpData;
            enResult = Ok;
            break;
        default:
            enResult = Error;
